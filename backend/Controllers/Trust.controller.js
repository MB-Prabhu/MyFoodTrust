...
let loginTrusts = async (req, res) => {
    try {
        ...
        let token = jwt.sign({ _id: isExist._id, role: 'trust' }, process.env.JWT_SECREAT_KEY, { expiresIn: process.env.JWT_TOKEN_EXPIRY })
        ...
        }) //in 40min cookie will expire as per expires property
